...
parser.add_argument('--style', type=str, default = 'style/udnie.jpg',
                    help='File path to the style image, or multiple style \
                    2222
                    images separated by commas if you want to do style \
                    interpolation or spatial control')
parser.add_argument('--steps', type=str, default = 1)
parser.add_argument('--vgg', type=str, default = "E:\Microsoft Edge Downloda(lunwen)\daima/xuyao/vgg_normalised.pth")
parser.add_argument('--decoder', type=str, default = "E:\Microsoft Edge Downloda(lunwen)\daima/xuyao/decoder_iter_500000.pth")
parser.add_argument('--transform', type=str, default = "E:\Microsoft Edge Downloda(lunwen)\daima/xuyao/transformer_iter_500000.pth")
